...
module.exports = {
  ...
  buildApp: function (options) {
    ...
    copyFile( root_dir + 'lib/template/app.js', app_dir + 'app.js');
    copyFile( root_dir + 'lib/template/package.json', app_dir + 'package.json');
    
    fs.mkdirSync(app_dir + 'resources/');
    var template = _.template( fs.readFileSync(root_dir + 'lib/template/resource.js', 'utf-8') );
